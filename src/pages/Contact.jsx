      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-wrap gap-3">
            <a href="https://www.facebook.com/sheikhtasmia25/" className="p-3 bg-white dark:bg-gray-800 shadow rounded-full hover:scale-110 transition transform"><FaFacebookF /></a>
            <a href="https://www.instagram.com/iamsheikhtasmia/" className="p-3 bg-white dark:bg-gray-800 shadow rounded-full hover:scale-110 transition transform"><FaInstagram /></a>
            <a href="https://www.linkedin.com/in/sheikh-tasmia/" className="p-3 bg-white dark:bg-gray-800 shadow rounded-full hover:scale-110 transition transform"><FaLinkedinIn /></a>
            <a href="https://medium.com/@sheikhtasmia" className="p-3 bg-white dark:bg-gray-800 shadow rounded-full hover:scale-110 transition transform"><FaMediumM /></a>
